...
/**
 * The base model interface for the mencoba2Entry service. Represents a row in the &quot;S_mencoba2Entry&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation {@link testing.model.impl.mencoba2EntryModelImpl} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link testing.model.impl.mencoba2EntryImpl}.
 * </p>
 *
 * @author sukri
 * @see mencoba2Entry
 ...
 */
@ProviderType
public interface mencoba2EntryModel extends BaseModel<mencoba2Entry>,
	GroupedModel, ShardedModel, StagedAuditedModel, WorkflowedModel {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a mencoba2 entry model instance should use the {@link mencoba2Entry} interface instead.
	 */
	...
	@Override
	public CacheModel<testing.model.mencoba2Entry> toCacheModel();
